import { Button } from '../Widgets/components/index.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 重新计算按钮位置 - 水平排列
    const buttonY = windowHeight / 2 - 60; // 两个按钮Y坐标相同，垂直居中
    ...
    // 创建两个按钮，指向同一页面但使用不同的查询参数
    const aiButton = new Button('AI 助手', './chat.html?mode=chat');
